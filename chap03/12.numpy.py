...
a = np.zeros((2, 5), np.int32)                      #   원소값 0 행렬 - 2행 5열, 32비트 정수형
b = np.ones((3, 1), np.uint8)                       #   원소값 1 행렬 - 3행 1열, 부호 없는 8비트 정수형
c = np.empty((1, 5), np.float64)                    #   값 없음 행렬 1행, 5열
...
print('c 형태: ', c.shape, ' d 형태: ', d.shape)    #   객체 형태

print(a), print(b)                                 #    객체 원소
print(c), print(d)