...
gray2gray = cv2.imread("images/image.jpg", cv2.IMREAD_GRAYSCALE)  # 명암도
gray2color = cv2.imread("images/image.jpg", cv2.IMREAD_COLOR)  # 컬러 영상

# 예외처리 - 영상파일 읽기 여부 조사
if gray2gray is None or gray2color is None:
    raise Exception("영상파일 읽기 에러")

print("해열 좌표 (100, 100) 화소값")
