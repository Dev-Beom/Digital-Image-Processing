...
color2unchanged1 = cv2.imread("images/image.tiff", cv2.IMREAD_UNCHANGED)
color2unchanged2 = cv2.imread("images/image.tiff", cv2.IMREAD_UNCHANGED)
...
print(title2, '원소 자료형', type(color2unchanged2[10][10][0]))  # 원소 자료형
print(title2, '화소값(3원소)', color2unchanged2[10][10])  # 한 화소 값 표시
