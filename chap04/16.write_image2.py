...
image8 = cv2.imread("images/image.jpg", cv2.IMREAD_COLOR)
...
cv2.imwrite("images/write_test_16.tif", image16)  # 16 비트 행렬 저장
cv2.imwrite("images/write_test_32.tif", image32)  # 32 비트 행렬 저장
